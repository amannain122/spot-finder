...
def save_coordinates():
    with open(r'C:\Users\ASUS\PycharmProjects\Spot Finder\data\rois.csv', 'a', newline='') as outf:
    ...
    print(f"Coordinates for rectangle {len(rois)} saved to 'data/rois.csv'")

# Load the image
image_path = r'C:\Users\ASUS\PycharmProjects\Spot Finder\image\output_image.png'
...
with open(r'C:\Users\ASUS\PycharmProjects\Spot Finder\data\rois.csv', 'w', newline='') as outf:
    csv_writer = csv.writer(outf)
...
print("Task completed. Coordinates saved to 'data/rois.csv'.")
