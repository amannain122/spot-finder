...
def save_coordinates():
    with open(r'C:\Users\ASUS\PycharmProjects\Spot Finder\data\rois2.csv', 'a', newline='') as outf:
    ...
    print(f"Coordinates for rectangle {len(rois)} saved to 'data/rois2.csv'")

# Load the image
image_path = r'C:\Users\ASUS\PycharmProjects\Spot Finder\image\output_image2.png'
...
with open(r'C:\Users\ASUS\PycharmProjects\Spot Finder\data\rois2.csv', 'w', newline='') as outf:
    csv_writer = csv.writer(outf)
...
print("Task completed. Coordinates saved to 'data/rois2.csv'.")
