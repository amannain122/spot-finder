...
const QRcodeconfirmation: React.FC = () => {
  ...
  return (
    <div style={{ padding: '20px', textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      ...
      <p style={{ fontSize: '1em' }}>Rating: {rating}</p>
      <div style={{ marginTop: '40px', display: 'flex', justifyContent: 'center', gap: '20px' }}>
        <Link href="/">
          <div style={{ width: '200px', height: '50px', backgroundColor: '#FFFFFF', borderRadius: '0', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0px 4px 4px rgba(0, 0, 0, 0.25)' }}>
            <span style={{ fontSize: '1em', fontWeight: 'normal', color: '#000000' }}>Home Page</span>
          </div>
        </Link>
        <Link href="/booking">
          <div style={{ width: '200px', height: '50px', backgroundColor: '#FFFFFF', borderRadius: '0', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0px 4px 4px rgba(0, 0, 0, 0.25)' }}>
            <span style={{ fontSize: '1em', fontWeight: 'normal', color: '#000000' }}>Previous Bookings</span>
          </div>
        </Link>
      </div>
    </div>
